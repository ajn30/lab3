...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(isset($_POST['submit'])){
        ...
        function sendemail_verify($firstname,$email, $verify_token, $otp){
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'aljuninato@gmail.com';
            $mail->Password = 'epedngwzvwyrfsum';
            $mail->SMTPSecure = 'ssl';
            $mail->Port = 465;
    
            $mail->setFrom('aljuninato@gmail.com');
        ...
        if (empty($email_message) && empty($uname_error)) {
            $sql = "INSERT INTO user (Firstname, Middlename, Lastname, Email, Status, username, password, verify_token, otp)
